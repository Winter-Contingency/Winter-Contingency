...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_UNSC = FREQ_UNSCCOMM,
	RADIO_CHANNEL_INNIE = FREQ_INNIECOMM
))
...
GLOBAL_LIST_INIT(reverseradiochannels, list(
	...
	"[FREQ_POLICE]" = RADIO_CHANNEL_POLICE,
	...
	"[FREQ_UNSCCOMM]" = RADIO_CHANNEL_UNSC,
	"[FREQ_INNIECOMM]" = RADIO_CHANNEL_INNIE
))
